...
> Answer: The boxplot is more effective because it contains the median, the spread, and the outlier of dry mass for each functional group, while the violin plot is greatly influnced by the outliers and doesn't well present the spread of the dry mass for eah functional group.
