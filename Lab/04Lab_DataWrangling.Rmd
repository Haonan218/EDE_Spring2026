...
> Answer: It is brittle and breaks when data is sorted, filtered, or rearranged, causing numbers to lose context
...
ex4 <-
  ex3 %>% 
  filter(depth == 0) %>% 
  summarize(mean_temperature = mean(temperature_C, na.rm = TRUE))
